...
class LoginController: UIViewController {
    ...
    func handleRegister() {
        ...
        FIRAuth.auth()?.createUser(withEmail: email, password: password, completion: { (user: FIRUser?, error) in
            ...
            let ref = FIRDatabase.database().reference(fromURL: "https://gameofchats-356d8.firebaseio.com/")
    ...
    func setupProfileImageView() {
        ...
        profileImageViewBottomAnchor = profileImageView.bottomAnchor.constraint(equalTo: loginRegisterSegmentedControl.topAnchor, constant: -12)
        profileImageViewBottomAnchor?.isActive = true
